...
Καθώς προχωράς στη μάθηση και τη χρήση της JavaScript, θα βρεθείς συχνά αντιμέτωπος με προβλήματα που θα σε κάνουν να σκεφτείς αν η ίδια η γλώσσα είναι υπεύθυνη για τα σφάλματα που εμποδίζουν την εκτέλεση του κώδικά σου. Θα νιώσεις οτι συγκριτκά με άλλες γλώσσες που πιθανώς έχεις δει, δεν βγάζει κανένα νόημα ο τρόπος με τον οποίο δουλεύει. Αυτό είναι κάτι που συμβαίνει σε όλους τους προγραμματιστές, ακόμα και σε αυτούς που έχουν χρόνια εμπειρίας.
